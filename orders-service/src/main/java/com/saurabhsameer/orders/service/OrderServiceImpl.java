...
import com.saurabhsameer.orders.dao.jpa.entity.OrderEntity;
import com.saurabhsameer.orders.dao.jpa.repository.OrderRepository;
...
public class OrderServiceImpl implements OrderService {
    ...
    public void approveOrder(UUID orderId) {
        ...
        Assert.notNull(orderEntity, "No order found with id: "+orderId +" in the database table");
    ...
    public void rejectOrder(UUID orderId) {
        ...
        OrderEntity orderEntity = orderRepository.findById(orderId).orElse(null);
        Assert.notNull(orderEntity, "No order found with id: "+orderEntity.getId());
